// src/theme.js — Premium FitForge Dark Theme
...
const theme = createTheme({
  palette: {
    mode: "dark",
    primary: {
      main: "#FF5722", // Deep forge orange
      light: "#FF8A65",
      dark: "#E64A19",
      contrastText: "#ffffff",
    },
    secondary: {
      main: "#424242", // Forge steel
      light: "#616161",
      dark: "#212121",
      contrastText: "#ffffff",
    },
    background: {
      default: "#0d0d0f", // Very deep neutral, almost black
      paper: "#151518", // Slightly lighter for cards
    },
    text: {
